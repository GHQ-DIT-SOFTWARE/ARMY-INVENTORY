...
@section('admin')
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">{{ isset($motorPool) ? 'Update Motor Pool' : 'Register Motor Pool' }}</h5>
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('vehicles.motor-pools.index') }}">Motor Pools</a></li>
    ...
    <div class="card shadow-sm">
        <div class="card-header">
            <h5 class="mb-0">Motor Pool Profile</h5>
        </div>
        <div class="card-body">
