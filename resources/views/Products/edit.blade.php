        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('updatepro') }}" method="POST" id="myForm" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="category_name" class="form-control">
                                            ...
                                            @foreach ($category as $cat)
                                                <option value="{{ $cat->id }}"
                                                    {{ $cat->id == $product->category_name ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control select2" name="state">
                                                <option value="">Select Option</option>
                                                <option {{ $product->state == '1' ? 'selected' : '' }} value="1">
                                                    Available</option>
                                                <option {{ $product->state == '0' ? 'selected' : '' }} value="0">
                                                    Unavailable</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="unit" class="col-sm-3 col-form-label">Product Image</label>
                                    <div class="col-sm-9">
