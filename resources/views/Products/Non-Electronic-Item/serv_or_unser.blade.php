...
@section('admin')
  ...
  <div class="col-sm-12">
    <div class="card">
        <div class="card-header">
            <h5> <span class="badge badge-primary mr-1">Scroll - Vertical Serviceable General Items</span></h5>
        </div>
        <div class="card-body">
  ...
  <div class="col-sm-12">
    <div class="card">
        <div class="card-header">
            <h5>
                <span class="badge badge-primary mr-1"> Scroll - Vertical, Unserviceable General Items</span>
               </h5>
        </div>
        <div class="card-body">
            <div class="dt-responsive table-responsive">
