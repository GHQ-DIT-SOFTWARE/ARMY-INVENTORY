            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Add General Item</a></li>
        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('store.nonpro')}}" method="POST" id="myForm" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="body_no" placeholder="Enter Item body No">
                                        @error('body_no')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
