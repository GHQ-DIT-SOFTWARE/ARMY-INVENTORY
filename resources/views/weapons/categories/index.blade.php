        ...
        <div class="page-block">
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('weapons.dashboard') }}"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge {{ $category->is_active ? 'bg-success' : 'bg-secondary' }}">
                                        {{ $category->is_active ? 'Serviceable' : 'Non-Serviceable' }}
                                    </span>
                                </td>
                                <td class="text-end">
                                    <a href="{{ route('weapons.categories.edit', $category) }}"
                                        class="btn btn-sm btn-outline-secondary">Edit</a>
                                    <form action="{{ route('weapons.categories.destroy', $category) }}" method="POST"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
